...
namespace AmpAuth.Core.Classes
{
	...
	public class PolicySetPolicyIssuerAttribute
	{
		private string attributeIdField;

		private PolicySetPolicyIssuerAttributeAttributeValue[] attributeValueField;
		...
		public PolicySetPolicyIssuerAttributeAttributeValue[] AttributeValue
		{
